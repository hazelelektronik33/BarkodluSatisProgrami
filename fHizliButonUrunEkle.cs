    ...
    public partial class fHizliButonUrunEkle : Form
    {
        ...
        private void gridUrunler_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
...

            {
                ...
                db.SaveChanges();
                MessageBox.Show("Buton Güncellenmiştir.");
        ...
        private void chTumu_CheckedChanged(object sender, EventArgs e)
        {
            if (chTumu.Checked)
            {
                ...
                gridUrunler.Columns["DolarAlisFiyat"].Visible = false;
                gridUrunler.Columns["DolarSatisFiyat"].Visible = false;
                gridUrunler.Columns["OzelKod"].Visible = false;
                gridUrunler.Columns["DolarKuru"].Visible = false;
