...
namespace BarkodluSatis
{
    public partial class fBaslangic : Form
    {
        ...
        private void bProje_Click(object sender, EventArgs e)
        {
            Cursor.Current = Cursors.WaitCursor;
            fProjeler f = new fProjeler();
            f.lKullanici.Text = lKullanici.Text;
            f.ShowDialog();
            Cursor.Current = Cursors.Default;
        }

        private void bCariHesap_Click(object sender, EventArgs e)
        {
            Cursor.Current = Cursors.WaitCursor;
            fCariAna f = new fCariAna();
            f.lKullanici.Text = lKullanici.Text;
            f.ShowDialog();
            Cursor.Current = Cursors.Default;
        }

        private void bServisFormu_Click(object sender, EventArgs e)
        {
            Cursor.Current = Cursors.WaitCursor;
            fTeknikServis f = new fTeknikServis();
            f.lKullanici.Text = lKullanici.Text;
            f.ShowDialog();
            Cursor.Current = Cursors.Default;
        }
