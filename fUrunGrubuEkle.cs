...
;        }
        ...
        private void bEkle_Click(object sender, EventArgs e)
        {
            if (tUrunGrupAd.Text!="")
            {
                ...
                GrupDoldur();
                tUrunGrupAd.Clear();
                MessageBox.Show("Ürün Gurubu Eklenmiştir.");
        ...
        private void bSil_Click(object sender, EventArgs e)
        {
            ...
            DialogResult onay = MessageBox.Show(grupad + "Grubunu silmek İstiyormusunuz?","Silme İşlemi",MessageBoxButtons.YesNo);
            if (onay==DialogResult.Yes)
            {
                ...
                GrupDoldur();
                tUrunGrupAd.Focus();
                MessageBox.Show(grupad + "Grup Silindi...");
                fUrunGiris f = (fUrunGiris)Application.OpenForms["fUrunGiris"];
                f.GrupDoldur();
