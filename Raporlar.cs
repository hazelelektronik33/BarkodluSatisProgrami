...
namespace BarkodluSatis
{
    static class Raporlar
    {
        ...
        public static string BaslangicTarihi { get; set; }
        public static string BitisTarihi { get; set; }
        ...
        public static void RaporSayfasiRaporu(DataGridView dgv)
        {
            ...
            prm[1] = new ReportParameter("BaslangicTarihi", BaslangicTarihi);
            prm[2] = new ReportParameter("BitisTarihi", BitisTarihi);
