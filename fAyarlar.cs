    ...
    public partial class fAyarlar : Form
    {
        ...
        private void bTeraziOnEkKaydet_Click(object sender, EventArgs e)
        {
            if (tTeraziOnEk.Text!="")
            {
                ...
                using (var db=new BarkodDbEntities())
                {
                    ...
                    {
                        MessageBox.Show(onek.ToString() + "Ön Ek Kayıtlı");
                    }
                    else
                    {
                        Terazi t = new Terazi();
        ...
        private void bTeraziOnEkSil_Click(object sender, EventArgs e)
        {
            if (cmbTeraziOnEk.Text!="")
            {
                ...
                DialogResult onay = MessageBox.Show(cmbTeraziOnEk.Text + "Ön Ek Silmek İstiyormusunuz?", "Terazi Önek Silme İşlemi",MessageBoxButtons.YesNo);
                if (onay==DialogResult.Yes)
                {
                    using (var db=new BarkodDbEntities())
                    {
                        ...
                        cmbTeraziOnEk.ValueMember = "Id";
                        cmbTeraziOnEk.DataSource = db.Terazi.ToList();
                        MessageBox.Show("Ön Ek Kaldırıldı");
                    }
                }
